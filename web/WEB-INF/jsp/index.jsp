    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-md-offset-1 col-sm-12 text-center page-title">
                <!-- /.feature title -->
                <h2>WHAT IS MICRO CREDIT?</h2>
                <p>Microcredit is the extension of very small loans (microloans) to impoverished borrowers who typically lack collateral, steady employment and a verifiable credit history.</p>
            </div>
        </div>
                    ...
                    <div id="testimonial-slider">
                        <div class="item">
                            <div class="client-text">
                                <p>I got opportunity to develop my business and grow my assets !</p>
                                <h4><strong>Hasitha, </strong><i>Business Man</i></h4>
                            </div>
                        ...
                        <div class="item">
                            <div class="client-text">
                                <p>I got opportunity to build new house and happy family life!</p>
                                <h4><strong>Namal, </strong><i>Teacher</i></h4>
                            </div>
                        ...
                        <div class="item">
                            <div class="client-text">
                                <p>I got opportunity to buy new Car and go work earlier!</p>
                                <h4><strong>Rakhitha, </strong><i>Engineer</i></h4>
                            </div>
                            <div class="client-face wow fadeInRight">
                                <img src="assets/img/client-face1.png" alt="">
                            </div>
                        ...
                        <div class="item">
                            <div class="client-text">
                                <p>I got opportunity to buy my tools and work like pro!</p>
                                <h4><strong>Chinthaka, </strong><i>Electrician</i></h4>
                            </div>
                            <div class="client-face wow fadeInRight">
                                <img src="assets/img/client-face2.png" alt="">
                            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-10 col-sm-offset-1 col-md-offset-0 col-xs-12">
                <div class="asks-first">
                    ...
                    <div class="asks-first-info">
                        <h2>ARE YOU LOOKING FOR A Loan?</h2>
                        <p> We have many loan schemes that suitable for your need</p>
                    </div>
            ...
            <div class="col-md-6 col-sm-10 col-sm-offset-1 col-xs-12 col-md-offset-0">
                <div  class="asks-first">
                    ...
                    <div class="asks-first-info">
                        <h2>WANT SUCCESS IN BUSINESS?</h2>
                        <p> Our business loan scheme will help grow your business up</p>
                    </div>
                    <div class="asks-first-arrow">
                        <a href="properties.html"><span class="fa fa-angle-right"></span></a>
                    </div>
