...
<div class="content-area recent-property" style="background-color: #FCFCFC; padding-bottom: 55px;">
    <div class="container">
        ...
        <c:forEach items="${approveMemberList}" var="member">
                            ...
                            <div class="panel panel-default col-md-8">
                                ...
                                <div id="fqa11" class="panel-collapse collapse fqa-body">
                                    <div class="panel-body">
                                        <ol>
                                            <li><b>NIC</b> ${member.nic}</li>
                                            <li><b>Telephone</b> ${member.telephone}</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-default" value="Approve"
                                        onclick="approve(${member.id})">Approve
                                </button>
                            </div>
                        </div>
                    </div>
...
<script>
    function approve(id) {
        var $frm = $("#approveForm");
        $("#memberId").val(id);
        $frm.attr("action", "approve").submit();
    }
</script>
